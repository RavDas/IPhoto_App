...
import static org.raveen.thesis.iphoto.utils.ImageUtils.safelyRemoveBitmap;
import static org.raveen.thesis.iphoto.utils.TestUtils.getBitmapFromFile;
import static org.raveen.thesis.iphoto.utils.TestUtils.getFaceMatFromFileIfCorrectSize;
    ...
    public void initActivity() throws IOException {
        ...
        Instrumentation.ActivityMonitor monitor =
                new Instrumentation.ActivityMonitor(
                        org.raveen.thesis.iphoto.PhotoMakerActivity.class.getName(), null, false);
        instrumentation.addMonitor(monitor);
        Intent intent = new Intent(
                instrumentation.getTargetContext(),
                org.raveen.thesis.iphoto.PhotoMakerActivity.class);
